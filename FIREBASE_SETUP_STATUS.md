...
- Project Number: `683185921702`
- Storage Bucket: `allergyapp-1a030.firebasestorage.app`
- API Key: `AIzaSyCIeuh9MhEnz4Og1GsF0q5PZwKH5Pj3DmA`
...
const firebaseConfig = {
  apiKey: "AIzaSyCIeuh9MhEnz4Og1GsF0q5PZwKH5Pj3DmA",
  ...
  appId: "1:683185921702:web:XXXXXXXXXX" // ← This will be different
};
```
...
```bash
EXPO_PUBLIC_FIREBASE_APP_ID=1:683185921702:web:YOUR_ACTUAL_WEB_APP_ID
```
